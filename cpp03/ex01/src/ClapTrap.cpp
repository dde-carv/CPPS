...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/29 17:02:26 by dde-carv          #+#    #+#             */
/*   Updated: 2025/09/29 17:02:27 by dde-carv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << GREEN << "ClapTrap (" << _name << ") default constructor called" << RST << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name) , _hitPoints(10) , _energyPoints(10) , _attackDamage(0)
{
	std::cout << GREEN << "ClapTrap (" << _name << ") costum constructor called" << RST << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap &object)
{
	*this = object;
	...
	std::cout << GREEN << "ClapTrap (" << _name << ") copy constructor called" << RST << std::endl;
}

ClapTrap::~ClapTrap()
{
	std::cout << RED << "ClapTrap (" << _name << ") default destructor called" << RST << std::endl;
}
